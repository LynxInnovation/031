...
#define HWVer20SD_POWER   PB4
#define SD_POWER          PB2
#define SD_POWER_PORT     PORTB

#define SD_PowerOn()      SetBit(SD_POWER_PORT,SD_POWER);ClearBit(SD_POWER_PORT,HWVer20SD_POWER)
#define SD_PowerOff()     ClearBit(SD_POWER_PORT,SD_POWER); SetBit(SD_POWER_PORT,HWVer20SD_POWER)
...
#define PortDirB          ((1 << MP3Reset) | (1 << CS) | (1 << SD_POWER) | (1 << SD_PWR1))
#define PortDirC          0
