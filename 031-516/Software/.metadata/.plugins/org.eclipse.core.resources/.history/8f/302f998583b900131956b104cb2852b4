...
#define SD_POWER0         PB4
#define SD_POWER1         PB2
#define SD_POWER_PORT     PORTB


#define SD_PowerOn(x)      SetBit(SD_POWER_PORT,SD_POWER##x)
#define SD_PowerOff(x)     ClearBit(SD_POWER_PORT,SD_POWER##x)
// SD
...
#define PortDirB          ((1 << MP3Reset) | (1 << SD_SS0) | (1 << SD_POWER0) | (1 << SD_POWER1) | (1 << SD_SS1))
#define PortDirC          0
